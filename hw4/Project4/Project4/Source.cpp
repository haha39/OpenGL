...
void My_Display()
{
	...
	glLoadIdentity();
	gluLookAt(0.0 + moveX, 0.0, 4.0 + moveZ, 0.0 + moveX, 0.0, 0.0 + moveZ, 0.0, 1.0, 0.0);
	...
	glPushMatrix();
		...
		glPushMatrix();
			glTranslatef(0.7 + moveX, 0.4, 2.0 + moveZ);
...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("HW4");	// Create the window with the title "HW2"
	init();
