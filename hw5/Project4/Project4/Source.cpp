...
void My_Display()
{
	...
	glLoadIdentity();
	gluLookAt(0.0 + moveX, 0.0 + jump, 4.0 + moveZ, 0.0 + moveX, 0.0 + jump, 0.0 + moveZ, 0.0, 1.0, 0.0);
	/* Floor */
	...
	glPushMatrix();
		...
		glTranslatef(0.0, 0.0 + jump, 0.0);




			////////////////////////////robot arm/////////////////////////////////
		float handcolor[3] = { 1.0f, 1.0f, 1.0f };
		glColor3fv(handcolor);
		glPushMatrix();
			glTranslatef(0.0 + moveX, 0.0, 2.0 + moveZ);
			glRotatef((GLfloat)50.0, 0.5, 0.4, -2.0);
			glScalef(2.0, 0.4, 1.0);
			glutWireCube(0.3);
		glPopMatrix();
		////////////////////////////robot elbow/////////////////////////////////
		glPushMatrix();
			glTranslatef(0.3 + moveX, 0.0, 2.0 + moveZ);
			glRotatef((GLfloat)50.0, 0.5, 0.4, 2.0);
			glScalef(2.0, 0.4, 1.0);
			glutWireCube(0.3);
		glPopMatrix();
		...
		glPopMatrix();*/
		////////////////////////////sun and planet/////////////////////////////////
		float starcolor[3] = { 0.5, 0.5, 0.5 };
		glColor3fv(starcolor);
		glPushMatrix();
			glTranslatef(0.7 + moveX, 0.4, 2.0 + moveZ-fire);
			glRotatef(90, 1.0, 0.0, 0.0);
			glRotatef(day, 0.0, 0.0, 5.0);
			glutWireSphere(0.1, 20, 8);    /* draw smaller planet */
			glTranslatef(0.2, 0.0, 0.0);
			glutWireSphere(0.05, 20, 8);    /* draw sun */
		glPopMatrix();
...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("HW5");	// Create the window with the title "HW2"
	init();
